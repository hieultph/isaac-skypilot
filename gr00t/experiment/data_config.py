...
class UavQuadrotorDataConfig(BaseDataConfig):
    video_keys = ["video.front_camera", "video.bottom_camera"]
    state_keys = [
        "state.position",
        "state.orientation", 
        "state.velocity",
    ...
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
    action_indices = list(range(16))  # UAV action horizon
    ...
    def transform(self) -> ModalityTransform:
        transforms = [
            ...
            StateActionTransform(
                ...
                action_horizon=16,
                action_dim=4,  # UAV has 4 control inputs
...
DATA_CONFIG_MAP = {
    ...
    "uav_quadrotor": UavQuadrotorDataConfig(),
}
